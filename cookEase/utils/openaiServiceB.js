...
export const generateRecipe = async (ingredientsInput, cookingTime, complexity,userId,country,serve) => {
  try {
    ...
    Otherwise, generate a simple ${country} recipe using the following ingredients. Assume that salt and water are available by default, but only include them if the recipe actually requires them.:  
    ...
    Number of Servings  
    [Just the number. Show on a new line.]
