          ...
          <View style={styles.grid}>
            ...
            */}
            ...
            <View style={[styles.box2, expandedWeight && styles.expandedBox]}>
              ...
              {/* Weight Report Chart Embedded Here */}
            ...
            <View style={[styles.box2, expandedCalories && styles.expandedBox]}>
              ...
              {/* Diet Report Chart Embedded Here */}
              <View style={styles.chartContainer}>
...
const styles = StyleSheet.create({
  ...
  box2: {width: "100%",height: 350,backgroundColor: "#fff",justifyContent: "center",alignItems: "center",borderRadius: 12,padding: 10,
    shadowColor: "#000",shadowOpacity: 0.1,shadowOffset: { width: 0, height: 5 },shadowRadius: 8,elevation: 5,},
