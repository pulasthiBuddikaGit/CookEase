...
const styles = StyleSheet.create({
  ...
  headerText: {fontSize: 18,fontWeight: 'bold',marginTop: 10,marginBottom: 5,color: '#0079b1',},
  subheaderText: {fontSize: 16,fontWeight: 'bold',marginTop: 8,marginBottom: 5,color: 'lightblue',},
  contentText: {fontSize: 16,lineHeight: 22,marginBottom: 5,color: 'black',fontWeight: 'bold',},
  spacer: {height: 10,},
